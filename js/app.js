...
function multiply(a, b) { //eslint-disable-line
  let product = a * b;
  let response = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let sumAB = sum(a, b);
  let sumABC = sum(sumAB[0], c);
  let sumText = a + ',' + b + ',' + c + ' was passed in as an array of numbers, and ' + sumABC[0] + ' is their sum.';

  return [sumABC[0], sumText];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let multABC = multiply(multAB[0], c);
  let multText = 'The numbers ' + a + ',' + b + ',' + c + ' have a product of ' + multABC[0] + '.';

  return[multABC[0], multText];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(let i = 1; i < dynamicArray.length; i++) {
    let multresult = multiply(dynamicArray[i], product);
    product = multresult[0];
  }
